...
var Data = struct {
	...
	Posts: []Post{
		...
		{ID: "3", Image: "prevent.jpg", Title: "How to Recognize and Prevent Diabetes Complications", Excerpt: template.HTML(`<p><span>Diabetes is a chronic condition that, if not well-managed, can lead to a range of serious health complications. Recognizing the early signs of complications and taking preventive measures can make a huge difference in maintaining quality of life for people with diabetes. In this post, we’ll cover common complications and practical steps you can take to prevent them.</span></p>`)},
		{ID: "4", Image: "workout.jpg", Title: "The Role of Exercise in Managing Diabetes", Excerpt: template.HTML(`<p>Physical activity plays a crucial role in managing diabetes. Regular exercise helps control blood sugar levels, improves cardiovascular health, and boosts overall well-being. Whether you have Type 1, Type 2, or gestational diabetes, incorporating physical activity into your daily routine can make a significant impact on managing the condition. In this post, we’ll explore the benefits of exercise for people with diabetes, the best types of exercises, and tips for incorporating them into your daily life.</p>`)},
		{ID: "5", Image: "stress.jpg", Title: "Stress and Diabetes: Understanding the Connection", Excerpt: template.HTML(`Managing stress is a crucial part of diabetes care. While diabetes requires careful attention to blood sugar levels through diet, exercise, and medication, stress is often an overlooked factor that can affect blood sugar control. Understanding the relationship between stress and diabetes is key to improving overall health and managing the condition more effectively. In this article, we’ll explore how stress impacts blood sugar levels and offer strategies for managing stress to improve diabetes outcomes.</p>`)},
	},
}
